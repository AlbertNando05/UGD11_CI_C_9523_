...
Class Branches extends REST_Controller{
    ...
    public function index_post($id = null){
        ...
        $branches->created_at = $this->db->set('created_at', 'NOW()', FALSE);
        if($id == null){
            $response = $this->CabangModel->store($branches);
        }else{
            $response = $this->CabangModel->update($branches,$id);
        }
    ...
    public function index_delete($id = null){
        ...
        $response = $this->CabangModel->destroy($id);
        return $this->returnData($response['msg'], $response['error']);
        }
